import 'package:mawaqit/services/reminder_service.dart';
      ...
      actions: [
        ElevatedButton(
          onLongPress: () {
            if (++longPressCount == 5) {
              updateAppBar(true);
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Developer options available")));
            }
          },
