...
class NotificationsService {
  ...
  static Future<NotificationDetails> _notificationDetails(String channelId) async {
  ...
  static Future showNotifications({int id = 0, String? title, String? body, String? payload}) async =>
      _notifications.show(id, title, body, await _notificationDetails(id.toString()), payload: payload);
